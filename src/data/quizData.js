...
export const QUIZ_DATA = {
  ...
  tax_refund_scam: {
    ...
    questions: [
      ...
      { q: 'Tax Refund 4 of 5', prompt: 'What information should you never share in response to an unsolicited tax refund offer?', correct: 2, options: ['Your city of residence', 'Your employer name', 'Your National ID, bank account, or OTP', 'Your email address'] },
  ...
  fake_job: {
    ...
    questions: [
      ...
      { q: 'Fake Job 3 of 5', prompt: 'An employer asks for your National ID, bank details, and passport before any formal offer. What do you do?', correct: 1, options: ['Provide everything — it\'s for HR onboarding', 'Verify the company is real before sharing any sensitive documents', 'Provide only your bank details', 'Share your passport but not National ID'] },
  ...
  identity_theft: {
    ...
    questions: [
      ...
      { q: 'Identity Theft 2 of 5', prompt: 'Which piece of information is most valuable to an identity thief?', correct: 2, options: ['Your Instagram username', 'Your favorite restaurant', 'Your National ID + date of birth + address together', 'Your first name and email'] },
